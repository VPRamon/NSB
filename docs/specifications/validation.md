...
| Solar spectrum | pinned TSIS-1 HSRS v2 p025nm and native LISIRD responses | W m^-2 nm^-1, 300–650 nm | exact regeneration; integral <= 0.05%, 445/551 shape <= 1% versus native | Implementation error or resolution-choice regression |
