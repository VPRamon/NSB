...
| --- | --- |
| `components::zodiacal` | Public `ZodiacalModel` source selection and independent `ZodiacalExtinction` propagation choice; concrete evaluator, brightness grid, spectrum construction, and component-only output remain internal |
