...
| Scientific metadata | Component metadata independently records maturity/provenance, F10.7 resolution, extinction assumptions, and structured geometry identity/configuration. |
| Numerical/scientific validation | Tests protect exact default/explicit Van Rhijn parity, zenith normalization, thin-shell convergence, near-horizon stability, integration refinement, altitude sensitivity, invalid-input rejection, and independent extinction scaling. |
