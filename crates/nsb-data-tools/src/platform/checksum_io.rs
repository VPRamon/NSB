...
impl FromStr for Checksum {
    ...
    fn from_str(raw: &str) -> Result<Self> {
        ...
        bail!("checksum must be algorithm-qualified")
    }
}
...
/// Compute SHA-256 as lowercase hexadecimal for formats that carry the algorithm separately.
...
mod tests {
    ...
    #[test]
    fn serde_requires_algorithm_qualified_checksums() -> Result<()> {
