...
use clap::Parser;
use nsb_data_tools::gaia::xp::continuous::{
    parse_datalink_gaiaxpy_csv, write_gaiaxpy_datalink_csv,
};
...
struct Args {
    ...
    #[arg(long, default_value = "canonical-batch")]
...
/// Run the `normalize_xp_continuous_coefficients` command using process arguments.
