...
use nsb_data_tools::gaia::acquisition::bulk::{BulkConfig, BulkDownloader, BulkPaths};
use nsb_data_tools::gaia::acquisition::datalink::{
        ...
        match response {
            Ok(response) => {
                ...
                if status.is_success()
                    && !nsb_data_tools::gaia::xp::sampled::contains_service_error(&body)
                {
...
fn merge_extract(
    ...
    for row in metadata {
        ...
        writer.write_record([
            ...
            &nsb_data_tools::gaia::xp::sampled::format_series(&product.wavelengths_nm, false),
            &nsb_data_tools::gaia::xp::sampled::format_series(&product.flux_w_m2_nm, true),
            &nsb_data_tools::gaia::xp::sampled::format_series(errors, true),
        ])?;
