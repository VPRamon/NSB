...
mod tests {
    ...
    fn index_builds_from_official_md5_manifest_head() {
        let md5_path = Path::new(
            "/home/valles/nsb-data/starlight-gaia-release/pilot-xp-continuous-bulk/bulk/_MD5SUM.txt",
        );
        if !md5_path.is_file() {
            return;
        }
        ...
        let index = build_index(
            &partial,
            Path::new("/home/valles/nsb-data/starlight-gaia-release/pilot-xp-continuous-bulk/bulk"),
            None,
        )
        .unwrap();
