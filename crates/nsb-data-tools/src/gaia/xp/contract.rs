...
use crate::gaia::xp::continuous::PHOTOMETRY_MODEL as CONTINUOUS_PHOTOMETRY_MODEL;
...
impl GaiaXpPhotonIntegrationContract {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.integration.owner != "nsb-data-tools::gaia::xp::sampled::integrate_photon_flux"
...
pub fn authoritative_gaia_xp_photon_contract() -> GaiaXpPhotonIntegrationContract {
    GaiaXpPhotonIntegrationContract {
        ...
        integration: IntegrationContract {
            owner: "nsb-data-tools::gaia::xp::sampled::integrate_photon_flux".to_string(),
